...
__global__ void tiled_mma(void *Cptr,
                          void const *Aptr,
                          void const *Bptr,
                          int m,
                          int n,
  ...
  //   print(tCgC); printf("\n");
  //   /*
  //   gmem_ptr[16b](0x7ad739000000) o ((_2,_2),_1,_2):((_1,128),_0,_8)
  //   gmem_ptr[16b](0x7ad739000400) o (_2,_1,_2):(_1,_0,_8)
  //   gmem_ptr[32b](0x7ad739001800) o ((_2,_2),_1,_1):((_1,256),_0,_0)
  //   */
  // }
  ...
  //   print(tCrC); printf("\n");
  //   /*
  //   ptr[16b](0x7ad74dfffcb0) o ((_2,_2),_1,_2):((_1,_2),_0,_4)
  //   ptr[16b](0x7ad74dfffcc0) o (_2,_1,_2):(_1,_0,_2)
  //   ptr[32b](0x7ad74dfffcd0) o ((_2,_2),_1,_1):((_1,_2),_0,_0)
  //   */
  // }
...
struct KernelSpec {
  ...
  // MMATileLayout is "permutation layout".
...
torch::Tensor run_tiled_mma(torch::Tensor const a,
  ...
  BOOL_SWITCH(is_gemm, IsGemm, [&] {
    ...
    tiled_mma<Spec, IsGemm, IsCvtPrecision><<<grid, block, shm_size, stream>>>(
